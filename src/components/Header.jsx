...
function Header() {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 dark:text-neutral-50 bg-neutral-50 dark:bg-neutral-900 
            ...
            <div>
                <div className={`w-12 h-12 mt-2 bg-[url(https://bryllemarius.vercel.app/assets/racoon1.png)] bg-center bg-cover bg-no-repeat dark:bg-[url(../assets/racoon1_light.png)]`}></div>
            </div>

            <div className='flex md:hidden h-full w-full items-center'>
                <div className="ms-auto border p-2 rounded-full" onClick={()=>{isActive()}}>
                    <div className="w-5 aspect-square bg-[url(https://bryllemarius.vercel.app/assets/menu.png)] dark:bg-[url(https://bryllemarius.vercel.app/assets/menu_light.png)] bg-center bg-cover bg-no-repeat"></div>
                </div>
            </div>
            ...
            <div className='col-span-2 p-2 my-2 rounded md:col-span-1 md:p-0 md:m-0 dark:bg-neutral-950 md:dark:bg-neutral-900'>
             ...
             <div className='hidden md:flex items-center justify-end pe-4 order-2'>
                 <div className='border dark:border-neutral-50 rounded-full p-2 cursor-pointer' onClick={()=>{change_mode()}}>
                     <div className='w-5 h-5 bg-[url(https://bryllemarius.vercel.app/assets/dark_mode.png)] bg-center bg-cover bg-no-repeat dark:bg-[url(https://bryllemarius.vercel.app/assets/light_mode.png)]' ></div>
                 </div>
             </div>
        </header>
    )
