...
import racoon_light from '../assets/racoon1_light.png'
...
function Header() {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 dark:text-neutral-50 bg-neutral-50 dark:bg-neutral-900 
            ...
            <div>
                <div className={`w-12 h-12 mt-2 bg-[url(./src/assets/racoon1.png)] bg-center bg-cover bg-no-repeat dark:bg-[url(${racoon_light})]`}></div>
            </div>
